      ...
      .prompt([
        {
          ...
          name: "main_action",
          choices: ["View All Departments", "View Department Budgets", "View All Roles", "View All Employees", "View Employees By Manager", "View Employees By Department", "Add Department", "Add Role", "Add Employee", "Update Employee Role", "Update Employee Manager", "Delete Department", "Exit"]
        }
      ])
      .then((response) => {
        switch(response.main_action) {
          ...
          case "View Employees By Department":
            db_employees.viewByDepartment(inquirer, main);
            break;
          case "Add Department":
          ...
          case "Delete Department":
            db_departments.deleteDepartment(inquirer, main);
            break;
          case "Exit":
